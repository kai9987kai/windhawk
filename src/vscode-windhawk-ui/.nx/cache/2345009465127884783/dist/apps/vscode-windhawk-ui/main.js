        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(NewModStudioModal_SectionTitle, {
          ...
          children: modStudioStarters.map(starter => /*#__PURE__*/(0,jsx_runtime.jsxs)(StarterCard, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(StarterHeader, {
              ...
              children: starter.key === 'ai-ready' ? t('newModStudio.starters.useAiReady') : t('newModStudio.starters.useStandard')
            })]
          }, starter.key))
        })]
...
const SidebarContainer = /*#__PURE__*/styled_components_browser_esm/* default */.Ay.div.withConfig({
  displayName: "EditorModeControls__SidebarContainer",
  componentId: "sc-16inpre-0"
})(["display:flex;flex-direction:column;gap:14px;padding:12px;color:var(--vscode-foreground);"]);
...
})(["display:flex;flex-direction:column;gap:12px;padding:14px;border-radius:12px;border:1px solid var(--vscode-widget-border,rgba(255,255,255,0.08));background:linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01)),var(--vscode-editor-background);"]);
...
const FullWidthDropdownButton = /*#__PURE__*/(0,styled_components_browser_esm/* default */.Ay)(dropdown/* default */.A.Button).withConfig({
  displayName: "EditorModeControls__FullWidthDropdownButton",
  componentId: "sc-16inpre-25"
})(["width:100%;.ant-btn:not(.ant-dropdown-trigger){width:calc(100% - 32px);}.ant-dropdown-trigger{width:32px;}"]);
...
function EditorModeControls({
  ...
  const compileProfileMode = isModDisabled ? isLoggingEnabled ? t('sidebar.compileMenu.disabledLogging') : t('sidebar.compileMenu.disabled') : isLoggingEnabled ? t('sidebar.compileMenu.logging') : t('sidebar.compileMenu.current');
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(SidebarContainer, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionTitle, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionTitle, {
        ...
        children: t('sidebar.sections.recommendedCompileDescription', {
      ...
      }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionColumn, {
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(CompileButtonBadge, {
          ...
          children: compileEditedModPending ? /*#__PURE__*/(0,jsx_runtime.jsx)(FullWidthDropdownButton, {
            type: "primary",
            loading: true,
            menu: {
              items: [{
            ...
            children: t('general.compiling')
          }) : /*#__PURE__*/(0,jsx_runtime.jsx)(FullWidthDropdownButton, {
            type: "primary",
            menu: {
              items: compileMenuItems
            },
            onClick: () => runCompile(),
            children: t('sidebar.compile')
          })
...
function App() {
  ...
  (0,react.useEffect)(() => {
    ...
    document.documentElement.setAttribute('data-windhawk-reduce-motion', String(localUISettings.reduceMotion));
