...
function isStartupPage(value) {
  return value === 'home' || value === 'explore' || value === 'settings' || value === 'about';
}
function isExploreDefaultSort(value) {
  return value === 'smart-relevance' || value === 'last-updated' || value === 'popular-top-rated';
}
function isEditorAssistanceLevel(value) {
  return value === 'streamlined' || value === 'guided' || value === 'full';
}
function isWindowsQuickActionDensity(value) {
...
function normalizeLocalUISettings(value) {
  ...
  return {
    ...
    startupPage: isStartupPage(candidate.startupPage) ? candidate.startupPage : defaultLocalUISettings.startupPage,
    exploreDefaultSort: isExploreDefaultSort(candidate.exploreDefaultSort) ? candidate.exploreDefaultSort : defaultLocalUISettings.exploreDefaultSort,
    editorAssistanceLevel: isEditorAssistanceLevel(candidate.editorAssistanceLevel) ? candidate.editorAssistanceLevel : defaultLocalUISettings.editorAssistanceLevel,
    windowsQuickActionDensity: isWindowsQuickActionDensity(candidate.windowsQuickActionDensity) ? candidate.windowsQuickActionDensity : defaultLocalUISettings.windowsQuickActionDensity
  };
}
...
function About() {
  ...
  const startupPageLabel = (0,react.useCallback)(startupPage => {
    switch (startupPage) {
      case 'explore':
  ...
  const exploreDefaultSortLabel = (0,react.useCallback)(sortPreference => {
    switch (sortPreference) {
      case 'last-updated':
        return t('settings.workflow.exploreDefaultSort.options.lastUpdated');
      case 'popular-top-rated':
        return t('settings.workflow.exploreDefaultSort.options.popularTopRated');
      case 'smart-relevance':
      default:
        return t('settings.workflow.exploreDefaultSort.options.smartRelevance');
    }
  }, [t]);
  const editorAssistanceLabel = (0,react.useCallback)(assistanceLevel => {
  ...
  const windowsQuickActionDensityLabel = (0,react.useCallback)(density => {
    switch (density) {
      case 'focused':
  ...
  const workspaceItems = (0,react.useMemo)(() => [{
    ...
    value: windowsQuickActionDensityLabel(localUISettings.windowsQuickActionDensity)
  }], [aiAccelerationLabel, appSettings, devModeOptOut, editorAssistanceLabel, exploreDefaultSortLabel, language, localUISettings, performanceProfileLabel, startupPageLabel, t, windowsQuickActionDensityLabel]);
  ...
  const visibleWindowsQuickActions = (0,react.useMemo)(() => {
    if (localUISettings.windowsQuickActionDensity === 'expanded') {
      return windowsQuickActions;
    }
    const focusedActionKeys = new Set(['windows-update', 'taskbar-settings', 'start-settings', 'notification-settings', 'multitasking-settings', 'colors-settings', 'app-data-folder', 'engine-folder']);
    return windowsQuickActions.filter(({
      key
    }) => focusedActionKeys.has(key));
  }, [localUISettings.windowsQuickActionDensity, windowsQuickActions]);
    ...
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(HeroCard, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(SectionCard, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(SectionHeading, {
          ...
          children: visibleWindowsQuickActions.map(({
            key,
            title,
            description,
            kind,
...
const modStudioStarters = [{
  ...
  highlights: ['Separates configuration, helpers, and hook setup from the start', 'Starts in a dry-run shape so you can inspect the target before adding hooks', 'Best default when you want a mod that stays readable as it grows'],
  ...
  highlights: ['Now organized into clearer settings, hook, and lifecycle sections', 'Good when you already know the hook strategy', 'Fastest path to a working sample with real behavior'],
  ...
  highlights: ['Starts with chrome.exe so Chrome-related mods are first-class in the create flow', 'Logs browser process and foreground window details before you choose a hook', 'Good for Chrome, Chromium, and other browser-family UI investigations'],
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(NewModStudioModal_SectionTitle, {
          ...
          children: modStudioStarters.map(starter => /*#__PURE__*/(0,jsx_runtime.jsxs)(StarterCard, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(StarterHeader, {
              ...
              }), starter.recommended && /*#__PURE__*/(0,jsx_runtime.jsx)(tag/* default */.A, {
                color: "blue",
...
function getDefaultExploreSortingOrder(preference) {
  return preference;
}
...
function ModsBrowserOnline({
  ...
  const [sortingOrder, setSortingOrder] = (0,react.useState)(() => getDefaultExploreSortingOrder(localUISettings.exploreDefaultSort));
  ...
  (0,react.useEffect)(() => {
    if (filterText.trim() === '') {
      setSortingOrder(getDefaultExploreSortingOrder(localUISettings.exploreDefaultSort));
    }
  }, [filterText, localUISettings.exploreDefaultSort]);
  const {
    getRepositoryMods
...
function Settings() {
  ...
  const getStartupPageLabel = (0,react.useCallback)(startupPage => {
    switch (startupPage) {
      case 'explore':
        return t('settings.workflow.startupPage.options.explore');
      case 'settings':
  ...
  const getExploreDefaultSortLabel = (0,react.useCallback)(sortPreference => {
    switch (sortPreference) {
      case 'last-updated':
        return t('settings.workflow.exploreDefaultSort.options.lastUpdated');
      case 'popular-top-rated':
  ...
  const getEditorAssistanceLabel = (0,react.useCallback)(assistanceLevel => {
    switch (assistanceLevel) {
      case 'streamlined':
        return t('settings.workflow.editorAssistance.options.streamlined');
      case 'guided':
  ...
  const getWindowsQuickActionDensityLabel = (0,react.useCallback)(density => {
    switch (density) {
      case 'focused':
        return t('settings.workflow.windowsQuickActions.options.focused');
      case 'expanded':
  ...
  const workflowSummary = (0,react.useMemo)(() => t('settings.workflow.currentSummary', {
    ...
    windows: getWindowsQuickActionDensityLabel(localUISettings.windowsQuickActionDensity)
  }), [getEditorAssistanceLabel, getExploreDefaultSortLabel, getStartupPageLabel, getWindowsQuickActionDensityLabel, localUISettings.editorAssistanceLevel, localUISettings.exploreDefaultSort, localUISettings.startupPage, localUISettings.windowsQuickActionDensity, t]);
  const statusItems = (0,react.useMemo)(() => {
    const items = [];
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(Settings_SettingsWrapper, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(SettingsHero, {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(SettingsSectionCard, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(Settings_SectionHeading, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SectionTitle, {
            children: t('settings.workflow.title')
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SectionDescription, {
            children: t('settings.workflow.description')
          })]
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)(SettingsList, {
          itemLayout: "vertical",
          split: false,
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(list/* default */.Ay.Item, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SettingsListItemMeta, {
              ...
              onChange: value => {
                setLocalUISettings({
                  startupPage: value === 'explore' ? 'explore' : value === 'settings' ? 'settings' : value === 'about' ? 'about' : 'home'
                });
              },
              dropdownMatchSelectWidth: false,
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "home",
                children: t('settings.workflow.startupPage.options.home')
              }, "home"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "explore",
                children: t('settings.workflow.startupPage.options.explore')
              }, "explore"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "settings",
                children: t('settings.workflow.startupPage.options.settings')
              }, "settings"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "about",
                children: t('settings.workflow.startupPage.options.about')
              }, "about")]
            })]
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(list/* default */.Ay.Item, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SettingsListItemMeta, {
              ...
              onChange: value => {
                setLocalUISettings({
                  exploreDefaultSort: value === 'last-updated' ? 'last-updated' : value === 'popular-top-rated' ? 'popular-top-rated' : 'smart-relevance'
                });
              },
              dropdownMatchSelectWidth: false,
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "smart-relevance",
                children: t('settings.workflow.exploreDefaultSort.options.smartRelevance')
              }, "smart-relevance"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "last-updated",
                children: t('settings.workflow.exploreDefaultSort.options.lastUpdated')
              }, "last-updated"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "popular-top-rated",
                children: t('settings.workflow.exploreDefaultSort.options.popularTopRated')
              }, "popular-top-rated")]
            })]
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(list/* default */.Ay.Item, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SettingsListItemMeta, {
              ...
              onChange: value => {
                setLocalUISettings({
                  editorAssistanceLevel: value === 'streamlined' ? 'streamlined' : value === 'guided' ? 'guided' : 'full'
                });
              },
              dropdownMatchSelectWidth: false,
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "streamlined",
                children: t('settings.workflow.editorAssistance.options.streamlined')
              }, "streamlined"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "guided",
                children: t('settings.workflow.editorAssistance.options.guided')
              }, "guided"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "full",
                children: t('settings.workflow.editorAssistance.options.full')
              }, "full")]
            })]
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(list/* default */.Ay.Item, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(Settings_SettingsListItemMeta, {
              ...
              onChange: value => {
                setLocalUISettings({
                  windowsQuickActionDensity: value === 'focused' ? 'focused' : 'expanded'
                });
              },
              dropdownMatchSelectWidth: false,
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "focused",
                children: t('settings.workflow.windowsQuickActions.options.focused')
              }, "focused"), /*#__PURE__*/(0,jsx_runtime.jsx)(es_select/* default */.A.Option, {
                value: "expanded",
                children: t('settings.workflow.windowsQuickActions.options.expanded')
              }, "expanded")]
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(SettingsNotice, {
...
function getEditorWindowsActions(metadata, maxItems = 4) {
  const matchedRules = getMatchedWindowsSurfaceRules(metadata == null ? void 0 : metadata.include);
  const actionKeys = Array.from(new Set([...(hasWildcardTargets(metadata == null ? void 0 : metadata.include) ? ['windows-update'] : []), ...(matchedRules.length > 0 ? matchedRules.flatMap(rule => rule.actions) : ['windows-update', 'taskbar', 'notifications'])])).slice(0, maxItems);
...
function getEditorProvocations(metadata, state) {
  const sessionState = Object.assign({}, DEFAULT_EDITOR_SESSION_STATE, state);
  const targets = getNormalizedTargets(metadata == null ? void 0 : metadata.include);
  const wildcardTargets = hasWildcardTargets(metadata == null ? void 0 : metadata.include);
  const surfaceSummary = getEditorWindowsSurfaceLabels(metadata).join(', ');
  ...
  const bestPracticeProvocation = metadata != null && metadata.version ? {
    key: 'best-practice',
...
function buildEditorChallengeBrief(modId, metadata, state) {
  const provocations = getEditorProvocations(metadata, state);
  return [buildEditorContextPacket(modId, metadata, state), '', 'Challenge prompts:', ...provocations.map(provocation => `- ${provocation.title}: ${provocation.body}`)].join('\n');
}
...
${buildEditorChallengeBrief(modId, metadata, state)}
...
${buildEditorChallengeBrief(modId, metadata, state)}
Current build status: ${state != null && state.compilationFailed ? 'recent compile failure' : 'build status not obviously failed'}
...
const ActionGroup = /*#__PURE__*/styled_components_browser_esm/* default */.Ay.div.withConfig({
  displayName: "EditorModeControls__ActionGroup",
  componentId: "sc-16inpre-27"
})(["display:flex;flex-direction:column;gap:10px;"]);
const ActionGroupTitle = /*#__PURE__*/styled_components_browser_esm/* default */.Ay.div.withConfig({
  displayName: "EditorModeControls__ActionGroupTitle",
  componentId: "sc-16inpre-28"
})(["font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.05em;color:var(--vscode-descriptionForeground,rgba(255,255,255,0.66));"]);
const ActionGroupDescription = /*#__PURE__*/styled_components_browser_esm/* default */.Ay.div.withConfig({
  displayName: "EditorModeControls__ActionGroupDescription",
...
const ProvocationList = /*#__PURE__*/(0,styled_components_browser_esm/* default */.Ay)(WorkflowList).withConfig({
  displayName: "EditorModeControls__ProvocationList",
  componentId: "sc-16inpre-43"
})([""]);
const ProvocationItem = /*#__PURE__*/(0,styled_components_browser_esm/* default */.Ay)(WorkflowItem).withConfig({
  displayName: "EditorModeControls__ProvocationItem",
  componentId: "sc-16inpre-44"
})(["background:rgba(255,255,255,0.035);"]);
const ProvocationTitle = /*#__PURE__*/(0,styled_components_browser_esm/* default */.Ay)(WorkflowTitle).withConfig({
  displayName: "EditorModeControls__ProvocationTitle",
  componentId: "sc-16inpre-45"
})([""]);
const ProvocationBody = /*#__PURE__*/(0,styled_components_browser_esm/* default */.Ay)(WorkflowBody).withConfig({
  displayName: "EditorModeControls__ProvocationBody",
...
function EditorModeControls({
  ...
  const provocations = (0,react.useMemo)(() => getEditorProvocations(metadata, editorSessionState), [editorSessionState, metadata]);
  ...
  const windowsActionLimit = localUISettings.windowsQuickActionDensity === 'expanded' ? Number.POSITIVE_INFINITY : 4;
  const windowsActions = (0,react.useMemo)(() => getEditorWindowsActions(metadata, windowsActionLimit), [metadata, windowsActionLimit]);
  const editorAssistanceLabel = (0,react.useMemo)(() => {
  ...
  const showEvidenceSection = localUISettings.editorAssistanceLevel !== 'streamlined';
  const showVerificationSection = localUISettings.editorAssistanceLevel !== 'streamlined';
  const showWorkflowSection = localUISettings.editorAssistanceLevel !== 'streamlined';
  const showProvocationSection = localUISettings.editorAssistanceLevel !== 'streamlined';
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(SidebarShell, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(SidebarScrollArea, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_HeroEyebrow, {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(tag/* default */.A, {
            ...
            color: localUISettings.editorAssistanceLevel === 'streamlined' ? 'gold' : localUISettings.editorAssistanceLevel === 'guided' ? 'blue' : 'geekblue',
            children: editorAssistanceLabel
          })]
      ...
      }), showEvidenceSection && /*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
      ...
      }), showProvocationSection && /*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
        $accent: "rgba(186, 104, 200, 0.14)",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionHeader, {
          children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(SectionKicker, {
              children: t('sidebar.sectionKickers.provocations')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionTitle, {
              children: t('sidebar.sections.provocations')
            })]
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionDescription, {
          children: t('sidebar.sections.provocationsDescription')
        }), /*#__PURE__*/(0,jsx_runtime.jsx)(ProvocationList, {
          children: provocations.map(provocation => /*#__PURE__*/(0,jsx_runtime.jsxs)(ProvocationItem, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ProvocationTitle, {
              children: provocation.title
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(ProvocationBody, {
              children: provocation.body
            })]
          }, provocation.key))
        }), showAiSection && /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
          block: true,
          onClick: () => copyTextWithFeedback(buildEditorChallengeBrief(modId, metadata, editorSessionState), t('sidebar.ai.copiedChallengeBrief')),
          children: t('sidebar.ai.challengeBrief')
        })]
      }), showVerificationSection && /*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
      ...
      }), showAiSection && /*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)(EditorModeControls_SectionHeader, {
        ...
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGroup, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupTitle, {
            children: t('sidebar.ai.understandingTitle')
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupDescription, {
            children: t('sidebar.ai.understandingDescription')
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGrid, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              ...
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('explain-api', modId, metadata, editorSessionState), t('sidebar.ai.copiedExplainApi')),
              children: t('sidebar.ai.explainApi')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('explain-terms', modId, metadata, editorSessionState), t('sidebar.ai.copiedExplainTerms')),
              children: t('sidebar.ai.explainTerms')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('usage-examples', modId, metadata, editorSessionState), t('sidebar.ai.copiedUsageExamples')),
              children: t('sidebar.ai.usageExamples')
            })]
          })]
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGroup, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupTitle, {
            children: t('sidebar.ai.challengeTitle')
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupDescription, {
            children: t('sidebar.ai.challengeDescription')
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGrid, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              ...
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('challenge-assumptions', modId, metadata, editorSessionState), t('sidebar.ai.copiedChallengeAssumptions')),
              children: t('sidebar.ai.challengeAssumptions')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('counterexample-hunt', modId, metadata, editorSessionState), t('sidebar.ai.copiedCounterexampleHunt')),
              children: t('sidebar.ai.counterexampleHunt')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('best-practices', modId, metadata, editorSessionState), t('sidebar.ai.copiedBestPractices')),
              children: t('sidebar.ai.bestPractices')
            })]
          })]
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGroup, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupTitle, {
            children: t('sidebar.ai.validationTitle')
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupDescription, {
            children: t('sidebar.ai.validationDescription')
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGrid, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
              ...
              block: true,
              onClick: () => copyTextWithFeedback(buildEditorAiPrompt('compile-recovery', modId, metadata, editorSessionState), t('sidebar.ai.copiedCompileRecovery')),
              children: t('sidebar.ai.compileRecovery')
            }), /*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupTitle, {
            children: t('sidebar.ai.buildTitle')
          }), /*#__PURE__*/(0,jsx_runtime.jsx)(ActionGroupDescription, {
            children: t('sidebar.ai.buildDescription')
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)(ActionGrid, {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)(es_button/* default */.A, {
              block: true,
      ...
      }), showWorkflowSection && /*#__PURE__*/(0,jsx_runtime.jsxs)(PanelCard, {
...
function AppBootSplash({
  ...
  const startupPageLabel = localUISettings.startupPage === 'explore' ? t('settings.workflow.startupPage.options.explore', {
    defaultValue: 'Explore'
  }) : localUISettings.startupPage === 'settings' ? t('settings.workflow.startupPage.options.settings', {
    defaultValue: 'Settings'
  }) : localUISettings.startupPage === 'about' ? t('settings.workflow.startupPage.options.about', {
    defaultValue: 'About'
  }) : t('settings.workflow.startupPage.options.home', {
    defaultValue: 'Home'
  });
  const performanceLabel = localUISettings.performanceProfile === 'responsive' ? t('settings.performance.profile.options.responsive', {
    defaultValue: 'Responsive'
  }) : localUISettings.performanceProfile === 'efficient' ? t('settings.performance.profile.options.efficient', {
    defaultValue: 'Efficient'
  }) : t('settings.performance.profile.options.balanced', {
    defaultValue: 'Balanced'
  });
  const aiAccelerationLabel = localUISettings.aiAccelerationPreference === 'prefer-npu' ? t('settings.performance.aiAcceleration.options.preferNpu', {
    defaultValue: 'Prefer NPU'
  }) : localUISettings.aiAccelerationPreference === 'off' ? t('settings.performance.aiAcceleration.options.off', {
    defaultValue: 'Off'
  ...
  const phases = [{
    ...
    key: 'bridge',
    label: t('splash.phases.bridge', {
      defaultValue: 'Extension bridge'
    }),
    state: extensionReady ? 'complete' : 'active'
  }, {
    key: 'shell',
    label: t('splash.phases.shell', {
      defaultValue: 'UI shell'
    }),
    state: translationsReady ? 'complete' : extensionReady ? 'active' : 'pending'
  }];
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: `app-boot app-boot--${panelMode}`,
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "app-boot__halo app-boot__halo--one"
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "app-boot__halo app-boot__halo--two"
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "app-boot__grid",
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("section", {
        className: "app-boot__hero",
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "app-boot__brand-row",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            className: "app-boot__mark",
            children: "WH"
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              className: "app-boot__eyebrow",
              children: t('splash.eyebrow', {
                defaultValue: 'Windhawk startup'
              })
            }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              className: "app-boot__brand",
              children: panelMode === 'sidebar' ? t('splash.sidebarBrand', {
                defaultValue: 'Editor cockpit'
              }) : t('splash.panelBrand', {
                defaultValue: 'Windhawk'
              })
            })]
          })]
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("h1", {
          className: "app-boot__title",
          children: panelMode === 'sidebar' ? t('splash.sidebarTitle', {
            defaultValue: 'Loading the editor cockpit'
          }) : t('splash.panelTitle', {
            defaultValue: 'Preparing your workspace'
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("p", {
          className: "app-boot__description",
          children: panelMode === 'sidebar' ? t('splash.sidebarDescription', {
            defaultValue: 'Syncing the editor surface, compile controls, and cockpit helpers before the current mod session opens.'
          }) : t('splash.panelDescription', {
            defaultValue: 'Applying your startup route, local workspace profile, and webview shell before the control center appears.'
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "app-boot__chips",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("span", {
            className: "app-boot__chip",
            children: t('splash.startingIn', {
              defaultValue: 'Starting in {{page}}',
              page: startupPageLabel
            })
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
            className: "app-boot__chip",
            children: t('splash.profile', {
              defaultValue: 'Profile: {{profile}}',
              profile: performanceLabel
            })
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
            className: "app-boot__chip",
            children: t('splash.aiAcceleration', {
              defaultValue: 'AI: {{mode}}',
              mode: aiAccelerationLabel
            })
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
            className: "app-boot__chip",
            children: localUISettings.useWideLayout ? t('splash.layoutWide', {
        ...
        className: "app-boot__status",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "app-boot__status-title",
          children: t('splash.statusTitle', {
            defaultValue: 'Startup progress'
          })
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "app-boot__phase-list",
          children: phases.map((phase, index) => /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            className: `app-boot__phase app-boot__phase--${phase.state}`,
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
              className: "app-boot__phase-index",
              children: index + 1
            }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
              className: "app-boot__phase-copy",
              children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                className: "app-boot__phase-label",
                children: phase.label
              }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
                className: "app-boot__phase-state",
                children: phase.state === 'complete' ? t('splash.phaseComplete', {
                  defaultValue: 'Ready'
                }) : phase.state === 'active' ? t('splash.phaseActive', {
          ...
          className: "app-boot__hint",
          children: t('splash.hint', {
            defaultValue: 'The first frame now stays visible while the extension bridge and language shell finish warming up.'
          })
        })]
      })]
    })]
...
function App() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(config_provider/* default */.Ay, {
    direction: direction,
    children: isBooting ? /*#__PURE__*/(0,jsx_runtime.jsx)(AppBootSplash, {
      content: content,
      extensionReady: !!appUISettings,
      translationsReady: ready,
      localUISettings: localUISettings,
      t: t
    }) : /*#__PURE__*/(0,jsx_runtime.jsx)(AppUISettingsContext.Provider, {
      value: appUISettings,
