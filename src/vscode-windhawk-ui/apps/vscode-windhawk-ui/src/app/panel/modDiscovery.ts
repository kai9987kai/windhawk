...
const DISCOVERY_MISSIONS: DiscoveryMission[] = [
  ...
  },
  {
    ...
    verificationChecks: [
      'Test file, folder, and desktop right-click flows separately before keeping the mod.',
      'Verify drag-drop and Open with behavior after any shell menu customization.',
      'Keep one unmodified path available in case the menu change hides a needed command.',
    ],
  },
  {
    key: 'desktop-calm',
    ...
    verificationChecks: [
      'Check empty-desktop, icon, and wallpaper behavior separately because they often use different hooks.',
      'Reload Explorer once before treating the visual result as stable.',
      'Confirm multi-monitor desktops still behave as expected after the change.',
    ],
  },
  {
    key: 'app-switching',
    ...
    verificationChecks: [
      'Exercise Alt+Tab, Win+Tab, and virtual desktop shortcuts before keeping the mod.',
      'Check whether DWM involvement makes the behavior build-sensitive on your Windows version.',
      'Verify app switching while full-screen and multi-monitor windows are open.',
    ],
  },
];
